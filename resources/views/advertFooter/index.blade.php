...
@section('content')
                                ...
                                <tbody>
                                    @foreach ($data as $img)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ URL::asset('/img/advertFooter/' . '' . $img->image) }}"
                                            ...
                                            <td>
                                                <a href="{{ url('edit-advert-footer', $img->id) }}"
                                            ...
                                            <td>
                                                <a href="{{ url('delete-advert-footer', $img->id) }}"
                                                    class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                                                    data-original-title="Edit user">
                                                    delete
                                                </a>
    ...
    <script>
        function myFunction(image) {
            const imgSrc = "{{ URL::asset('img/advertFooter/') }}/" + image;
